--[[----------------------------------------------------------------------------
	LoseControlCoA - localization strings.
	Part of LoseControlCoA, adapted for Ascension WoW: Conquest of Azeroth.
	...
	Software Foundation, version 3 of the License (see LICENSE.txt). It is
